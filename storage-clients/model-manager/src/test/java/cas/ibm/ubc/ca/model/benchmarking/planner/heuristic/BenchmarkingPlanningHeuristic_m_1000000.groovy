package cas.ibm.ubc.ca.model.benchmarking.planner.heuristic;
...
@BenchmarkMethodChart(filePrefix = "model-planning-heuristic-1000000_messages")
@BenchmarkHistoryChart(labelWith = LabelType.RUN_ID, maxRuns = 20)
class BenchmarkingPlanningHeuristic_m_1000000 {
