...
@BenchmarkMethodChart(filePrefix = "model-planning-smt-hosts_diff-10_messages")
...
//		createFiles(svcs, hosts, msgs)
	...
	void testBuildModel_10_Messages_10_Services() {
		def x = createMock(10,10,MESSAGES); printNumberMoves("10_10_${MESSAGES}.txt",x); printNumberMoves("10_10_${MESSAGES}.txt",x)
	}
