...
public class ServiceReplicaImpl extends ServiceImpl implements ServiceReplica {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SERVICE_REPLICA;
	}
	...
	public List<Message> getMessages() {
		if (messages == null) {
			messages = new EObjectContainmentEList<Message>(Message.class, this, ModelPackage.SERVICE_REPLICA__MESSAGES);
		}
		return messages;
	}
	...
	public void setContainer(String newContainer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVICE_REPLICA__CONTAINER, oldContainer, container));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVICE_REPLICA__ID, oldId, id));
	}
	...
	public void setAddress(String newAddress) {
		...
		address = newAddress;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVICE_REPLICA__ADDRESS, oldAddress, address));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SERVICE_REPLICA__MESSAGES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SERVICE_REPLICA__MESSAGES:
				return getMessages();
			case ModelPackage.SERVICE_REPLICA__CONTAINER:
				return getContainer();
			case ModelPackage.SERVICE_REPLICA__ID:
				return getId();
			case ModelPackage.SERVICE_REPLICA__ADDRESS:
				return getAddress();
		}
