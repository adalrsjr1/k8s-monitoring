...
public class StringToLongMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Long> {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.STRING_TO_LONG_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STRING_TO_LONG_MAP__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Long newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STRING_TO_LONG_MAP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.STRING_TO_LONG_MAP__KEY:
				return getTypedKey();
			case ModelPackage.STRING_TO_LONG_MAP__VALUE:
