...
public class AffinityImpl extends MinimalEObjectImpl.Container implements Affinity {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.AFFINITY;
	}
		...
		if (with != null && with.eIsProxy()) {
			...
			if (with != oldWith) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.AFFINITY__WITH, oldWith, with));
			}
		}
		return with;
	}
	...
	public void setWith(Service newWith) {
		...
		with = newWith;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AFFINITY__WITH, oldWith, with));
	}
	...
	public void setDegree(Float newDegree) {
		...
		degree = newDegree;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AFFINITY__DEGREE, oldDegree, degree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.AFFINITY__WITH:
				if (resolve) return getWith();
				return basicGetWith();
			case ModelPackage.AFFINITY__DEGREE:
				return getDegree();
		}
