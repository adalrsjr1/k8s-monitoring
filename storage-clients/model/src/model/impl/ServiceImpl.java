...
public abstract class ServiceImpl extends ElementWithResourcesImpl implements Service {
	...
	public List<Affinity> getHasAffinities() {
		if (hasAffinities == null) {
			hasAffinities = new EObjectContainmentEList<Affinity>(Affinity.class, this, ModelPackage.SERVICE__HAS_AFFINITIES);
		}
	...
	public void setPort(Integer newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVICE__PORT, oldPort, port));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SERVICE__HAS_AFFINITIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SERVICE__NAME:
				return getName();
			case ModelPackage.SERVICE__PORT:
				return getPort();
		}
